...
import com.example.adminapp.Model.VideoDetailUpload;
import com.example.adminapp.R;
import com.example.adminapp.Activity.UploadThumbnailActivity;
...
public class MainActivity1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    EditText video_description, video_name;
    Button logout;
                            ...
                            storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uris) {
                                    ...
                                    VideoDetailUpload videoDetailUpload = new VideoDetailUpload("",""
                                            ,"",video_url1
                                            ,video_name.getText().toString(), video_description.getText().toString(),songsCategory
                                    );
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 101 && resultCode == RESULT_OK && data.getData() != null) {
            ...
            cursor = MainActivity1.this.getContentResolver().query(videoUri, projection, null,null,orderby);
    ...
    private void startthunailActivity(){
        Intent in = new Intent(MainActivity1.this, UploadThumbnailActivity.class);
