...
import com.example.adminapp.Activity.MoviePlayerActivity;
...
public class FloatingWidgetService extends Service {
            ...
            imageViewMaximize.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(mwindowManager != null && mFloatingWidget.isShown() && exoPlayer != null)
                    {
                        ...
                        exoPlayer = null;
                        stopSelf();
                        Intent openActivtyIntent = new Intent(com.example.adminapp.Services.FloatingWidgetService.this, MoviePlayerActivity.class);
    ...
    public void playVideos(){
        ...
        try {
            ...
            exoPlayer = ExoPlayerFactory.newSimpleInstance(com.example.adminapp.Services.FloatingWidgetService.this,trackSelector);
