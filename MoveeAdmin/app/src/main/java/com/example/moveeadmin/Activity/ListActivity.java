...
import com.example.moveeadmin.Adapter.SliderPagerAdapterNew;
...
import com.example.moveeadmin.Model.SliderSide;
...
public class ListActivity extends AppCompatActivity implements MovieItemClickListenerNew {
...
//    }
    ...
    private void getActionMovies(){
        ...
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(ListActivity.this, "Tab Action Seleted:", Toast.LENGTH_SHORT).show();
    }
