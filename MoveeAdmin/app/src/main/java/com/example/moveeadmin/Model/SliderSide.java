package com.example.moveeadmin.Model;


public class SliderSide {

    public String video_slide, video_type,video_thumb,
                  video_url,video_name,video_extension,
                  duration, video_description,video_category;
