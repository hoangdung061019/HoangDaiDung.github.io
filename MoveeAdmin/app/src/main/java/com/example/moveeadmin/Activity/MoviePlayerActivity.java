...
import com.example.moveeadmin.Services.FloatingWidgetService;
       ...
       //hideActionBar();
        ...
        exo_floating_widget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                exoPlayer.release();
                Intent serviceintent = new Intent(com.example.moveeadmin.Activity.MoviePlayerActivity.this, FloatingWidgetService.class);
