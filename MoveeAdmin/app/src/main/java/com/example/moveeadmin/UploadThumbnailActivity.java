package com.example.moveeadmin;
...
import com.example.moveeadmin.Activity.MainActivity;
    ...
    private void seletedBestAndLatestMovies(){
        ...
        radioSlidermovies.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(UploadThumbnailActivity.this, "Đã chọn : "+movieslide, Toast.LENGTH_SHORT).show();
